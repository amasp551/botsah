...
import threading
stopuser = {}
token = '7091605729:AAGOQotXH99dZ6QBcS4wU_sco5-jkPWw-5A'
	...
	def my_function():
	  ...
	  "timer": "none",
		...
		if BL == '𝗙𝗥𝗘𝗘':	
			...
			ahmed = types.InlineKeyboardButton(text="‌ 𝗢𝗪𝗡𝗘𝗥  ‌", url="https://t.me/K_V_01")
			contact_button = types.InlineKeyboardButton(text="‌ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ‌", url="https://t.me/y_2_09")
...
𝒀𝑶𝑼𝑹 𝑷𝑳𝑨𝑵 𝑵𝑶𝑾 {BL}</b>
	''',reply_markup=keyboard)
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="‌ 𝗢𝗪𝗡𝗘𝗥 ‌", url="https://t.me/K_V_01")
		ahmed = types.InlineKeyboardButton(text="‌ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 ‌", url="https://t.me/y_2_09")
		keyboard.add(contact_button, ahmed)
...
𝘽𝙤𝙩 𝘽𝙮 @K_V_01''', reply_markup=mes)
...
def respond_to_vbv(message):
  ...
  "timer": "none",
	...
	if BL == '𝗙𝗥𝗘𝗘':
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text="‌ 𝗢𝗪𝗡𝗘𝗥  ‌", url="@K_V_01")
		ahmed = types.InlineKeyboardButton(text="‌ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇  ‌", url="https://t.me/y_2_09")
		keyboard.add(contact_button, ahmed)
...
𝗧𝗛𝗘 𝘾𝙃𝘼𝙉𝙉𝙀𝙇'𝗦 ??𝗢𝗕 𝗜𝗦 𝗧𝗢 𝗖𝗛𝗘𝗖?? 𝗖𝗔𝗥𝗗𝗦
